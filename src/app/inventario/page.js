  ...
  return (
    <div className="relative h-[calc(100vh-5rem)]">
        <div className="flex w-full">
            <div className="flex rounded-md border overflow-hidden mx-3 w-1/2 max-w-md font-[sans-serif]">
        ...
        <div className="font-[sans-serif] overflow-x-auto my-3 mx-3 overflow-y-auto h-[calc(100vh-19rem)]">
            <table className="min-w-full bg-white border">
                ...
                <tr className="even:bg-blue-50 text-sm text-black" key={post.idProducto}>
                    <td className="p-4 ">{post.idProducto}</td>
                    <td className="p-4 ">{post.nombre}</td>
                    <td className="p-4 ">{post.precio}</td>
                    <td className="p-4 ">{post.stock}</td>
                    <td className="p-4 "></td>
                    <td className="p-4">
