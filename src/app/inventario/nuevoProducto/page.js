    ...
    <div className="relative px-4 h-[calc(100vh-5rem)]">
        ...
        <div className="flex rounded-md border overflow-hidden w-1/2 max-w-md font-[sans-serif]">
            <input
              ...
              type="text" placeholder="Descripción" className="w-full outline-none bg-white text-gray-600 text-sm px-3 py-2" 
            />
        </div>
        ...
        <div className="flex rounded-md border overflow-hidden w-1/2 max-w-md font-[sans-serif]">
            <input 
              ...
              type="number" placeholder="Precio" className="w-full outline-none bg-white text-gray-600 text-sm px-3 py-2" 
            />
        </div>
        ...
        <div className="flex rounded-md border overflow-hidden w-full max-w-md font-[sans-serif]">
            <input 
              ...
              type="number" placeholder="Stock" className="w-full outline-none bg-white text-gray-600 text-sm px-3 py-2" 
            />
        </div>
        ...
        <div className="flex rounded-md border overflow-hidden w-1/2 max-w-md font-[sans-serif]">
            <input
                ...
                type="text" placeholder="Código del producto" className="w-full outline-none bg-white text-gray-600 text-sm px-3 py-2" />
